# AetherROM
AetherROM is a work-in-progress custom ROM for Samsung Galaxy Galaxy S24 FE.

# What is AetherROM?
AetherROM is a work-in-progress custom ROM for Samsung Galaxy Galaxy S24 FE.

Note: This custom ROM project is based on ExtremeROM!!!

It's based on the Samsung's OneUI 7 and it also includes additional features and tweaks to ensure the best possible experience out of the box.
...
AetherROM supports only Galaxy S24 FE Global Version(SM-S721B)!
...
- Stock Kernel without root(KernelSU-Next coming soon!)
- Now Brief Support
- Adaptive color tone support
- Super HDR support
- Adaptive Brightness support
- Full CSC support
- Adaptive Refresh Rate support(120Hz)
- Multi-User support
- AppLock support
- EroFS partitions
...
# AetherROM Credits
- **[ArtisanROM](https://github.com/ArtisanROM)** for the Galaxy S24 FE target and platform from their older ROM projects and for ViperFX implementaion from ArtisanROM
- **[WalterGrayzz](https://github.com/WalterGrayz)** for his help in original repository and for wallpapers
